...
class TestDsrSetCli(unittest.TestCase):
	...
	# 	calc_coord_cli_req.input_pos_cnt = 1
	...
	# 	self.assertAlmostEqual(x1[0], calc_coord_cli_resp.conv_posx[0], delta=0.1)
	# 	self.assertAlmostEqual(x1[1], calc_coord_cli_resp.conv_posx[1], delta=0.1)
	# 	self.assertAlmostEqual(x1[2], calc_coord_cli_resp.conv_posx[2], delta=0.1)
	# 	self.assertAlmostEqual(x1[3], calc_coord_cli_resp.conv_posx[3], delta=0.1)
	# 	self.assertAlmostEqual(x1[4], calc_coord_cli_resp.conv_posx[4], delta=0.1)
	# 	self.assertAlmostEqual(x1[5], calc_coord_cli_resp.conv_posx[5], delta=0.1)
	...
	""" TODO : Need the code to check the result """
	...
	""" TODO : How Can Create DSR with Gripper? """
	""" Gripper """
	## Robotiq 2F Close
...
if __name__ == '__main__':
	moveSuite = unittest.TestLoader().loadTestsFromTestCase(TestDsrMoveCli)
	setSuite = unittest.TestLoader().loadTestsFromTestCase(TestDsrSetCli)

	runner = unittest.TextTestRunner()
	print("Running DSR Move Service Client Test!")
	runner.run(moveSuite)

	print("Running DSR Setting Service Client Test!")
	runner.run(setSuite)